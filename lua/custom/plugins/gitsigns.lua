-- Extends the base gitsigns spec in init.lua with personal sign glyphs,
-- staged-hunk signs, and additional hunk/blame/diff keymaps.
-- `opts` deep-merges across specs for the same plugin, so this composes
-- with init.lua's spec instead of overriding it.
